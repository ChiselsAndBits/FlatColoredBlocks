...
public final class Items
{
    ...
    public final static IRegistryObject<BlockItem> PAINT_MIXER = ITEM_REGISTRAR.register("paint_mixer", () -> new BlockItem(Blocks.PAINT_MIXER.get(), new Item.Properties()));
    public final static IRegistryObject<BlockItem> PAINT_BASIN = ITEM_REGISTRAR.register("paint_basin", () -> new BlockItem(Blocks.PAINT_BASIN.get(), new Item.Properties()));
    public final static IRegistryObject<BlockItem> COLORED_CONCRETE = ITEM_REGISTRAR.register("colored_concrete", () -> new ColoredBlockItem(Blocks.COLORED_CONCRETE.get(), new Item.Properties()));
    public final static IRegistryObject<BlockItem> COLORED_WOOL = ITEM_REGISTRAR.register("colored_wool", () -> new ColoredBlockItem(Blocks.COLORED_WOOL.get(), new Item.Properties()));
    public final static IRegistryObject<BlockItem> COLORED_WOOL_CARPET = ITEM_REGISTRAR.register("colored_wool_carpet", () -> new ColoredBlockItem(Blocks.COLORED_WOOL_CARPET.get(), new Item.Properties()));
